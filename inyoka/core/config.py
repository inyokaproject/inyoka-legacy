...
DEFAULTS = {
    ...
    'routing.static.subdomain':     TextField(default=u'static',
        help_text=lazy_gettext(u'Subdomain used for the static application')),
    'routing.static.submount':      TextField(default=u'/',
        help_text=lazy_gettext(u'Submount used for the static application')),
    'routing.media.subdomain':     TextField(default=u'media',
